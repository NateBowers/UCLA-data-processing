...
'''
Convert PICAM images from raw .h5 files into .tiff files, and record the
programmed and calculated delay for each shot, based off the photodiodes
hooked up to LeCroy channels 1 and 2.
'''
